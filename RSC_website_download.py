...
save_directory = r'D:\PycharmProjects\Extract_table\RSC_website'
...
url_lists = open(r'RSC_Url_lists.txt', 'r')
...
for i in url_lists[len(os.listdir(save_directory)):]:
    try:
        ...
        print(url)
        sleep(5)
        # list = driver.find_elements(By.CLASS_NAME,"btn btn--primary btn--tiny")
        list = driver.find_elements(By.CSS_SELECTOR,'[class="btn btn--primary btn--tiny"]')
        print(list)
        sleep(5)
